...
def XOR(x,y):
    return gand(gnot(gand(x,y)), gor(x,y))
...
def FA(x,y,cin):
    ...
    # if xANDy are 1s OR xANDcin are 1s OR yANDcin are 1s
...
def fourBitAdd(xxxx,yyyy):
    ...
    (carry2,zt) = FA(xxxx[2],yyyy[2],carry)
    (carry3,zf) = FA(xxxx[1],yyyy[1],carry2)
    (carry4,ze) = FA(xxxx[0],yyyy[0],carry3)
    return (carry4,(ze, zf,zt,zo))


# EXERCISE: implement the following.
def test_fourBitAdd():
    '''at least four test cases'''
    print(fourBitAdd((0,0,0,1),(0,0,0,1)))
    ...
    print("Successfully completed test cases")
