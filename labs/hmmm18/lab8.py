...
Example1 = """
00 read input1          # get # from user to r1
01 ditto input2          # ditto, for r2
02 mul output input1 input2     # assign r3 = r1 * r2
03 write output         # print what's in r3
04 halt             # stop.
"""
...
#Input: n
#Assume: n >= 0
#Output: n terms in fibonacci seq.

#r1 is length, r2 is counter, r3 to check if counter is at length
#r4 is one, r5 is two
